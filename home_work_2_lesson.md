...
### Конфликт слияания и его разрешения
Конфликт сляния бывает в случае разных/одинаковых значений в одинаковы строчках или блоках. Гит предоставляет право выбора, какое иизменение оставить, а так же есть возможнать вручную внести корректировки в области , кгде произошел конфликт.
